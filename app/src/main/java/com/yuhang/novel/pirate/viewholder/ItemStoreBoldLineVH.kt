...
import com.yuhang.novel.pirate.databinding.ItemStoreBoldLineBinding
import com.yuhang.novel.pirate.databinding.ItemStoreLineBinding
import com.yuhang.novel.pirate.ui.common.model.LineModel

class ItemStoreBoldLineVH(parent:ViewGroup):BaseViewHolder<LineModel, ItemStoreBoldLineBinding>(parent, R.layout.item_store_bold_line) {
