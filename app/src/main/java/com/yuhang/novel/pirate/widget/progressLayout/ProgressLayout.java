 ...
 */
package com.yuhang.novel.pirate.widget.progressLayout;
...
public class ProgressLayout extends View implements Animatable {
    ...
    public void setCurrentProgress(int currentProgress) {
        if (currentProgress * 10 <= this.currentProgress && currentProgress != 0) {
            return;
        }
    ...
    public void setProgressLayoutListener(ProgressLayoutListener progressLayoutListener, Object obj) {
            ...
            if (isPlaying) {
                if (currentProgress == maxProgress) {
                    if (progressLayoutListener != null) {
                        progressLayoutListener.onProgressCompleted(obj);
                    }
                    currentProgress = 0;
