...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = PirateApp.Companion.getInstance().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = PirateApp.Companion.getInstance().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics = PirateApp.Companion.getInstance()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
