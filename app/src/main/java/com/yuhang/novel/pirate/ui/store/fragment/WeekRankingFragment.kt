...
class WeekRankingFragment : BaseFragment<FragmentWeekRankingBinding, WeekRankingViewModel>(),
    ...
    override fun initData() {
        super.initData()
        mViewModel.queryKanShuRanking(name, gender, type, KanShuRankingActivity.TYPE_WEEK)
...
//        addOnScrollListener(mBinding.recyclerview)
    ...
    override fun onRefresh(refreshLayout: RefreshLayout) {
        ...
        PAGE_NUM = 1
        mViewModel.getKanShuRanking(name, gender, type, KanShuRankingActivity.TYPE_WEEK, PAGE_NUM)
            .compose(bindToLifecycle())
            .subscribe({
