...
import com.yuhang.novel.pirate.widget.PageChangeListener
import com.yuhang.novel.pirate.widget.TabLayoutListener
...
class StoreFragmentV2 :BaseFragment<FragmentStoreV2Binding, StoreViewModelV2>(),
    ...
    private fun initTabLayoutView() {
        val pagerAdapter = ViewPagerAdapter(childFragmentManager, mViewModel.mTitles, mViewModel.mFragments)
